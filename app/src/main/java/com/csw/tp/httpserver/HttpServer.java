...
public class HttpServer
{
	 ...
	 * @param parms	Parsed, percent decoded parameters from URI and, in case ofGETT, data.
	...
	public class Response
	{
		...
		public Response( String status, String mimeType, String txt )
		{
			...
			// 	this.data = new ByteArrayInputStream( txt.getBytes("GBK"));
			}
			...
			throws InterruptedException
		{
			try {
				...
				String inLine = in.readLine();
			 	inLine=new String(inLine.getBytes("ISO-8859-1"),"GBK");
			...
			try
			{
				...
				while ( mpline != null )
				{
					...
					if (mpline != null)
					{
						...
						{
							sendError( HTTP_BADREQUEST, "BAD REQUEST: Content type is multipart/form-data but no content-disposition info found. Usage: POST /example/file.html" );
						}
    ...
    public String getGb2312Url(String s){  
        try {  
